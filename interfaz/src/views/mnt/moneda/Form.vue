<template>
	<form @submit.prevent="guardar">
		...
		<div class="row mb-3">
			<label for="inputNombre" class="col-sm-2 col-form-label fw-bold">
		...
		<div class="row mb-3">
			<label for="inputSimbolo" class="col-sm-2 col-form-label fw-bold">
				Símbolo: <span class="fw-bold text-danger">*</span>
			</label>
			<div class="col-sm-10">
				<input 
					id="inputSimbolo" 
